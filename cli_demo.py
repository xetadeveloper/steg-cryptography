# # from crypto import rsa_module

# # private_key, public_key = rsa_module.generate_rsa_keypair()
# # rsa_utils.save_private_key(private_key, "private.pem")
# # rsa_utils.save_public_key(public_key, "public.pem")
...
#     # Step 1: Generate RSA keypair (you can skip this if keys already exist)
...
#     # Step 2: Generate AES key (32 bytes for AES-256)
#     aes_key = os.urandom(32)
#     print(f"🔑 Generated AES Key: {aes_key.hex()}\n")

#     # Step 3: Encrypt AES key with public RSA key
#     print("🔒 Encrypting AES key with RSA public key...")
#     loaded_public = rsa_utils.load_public_key("public.pem")
#     encrypted_aes_key = rsa_utils.encrypt_aes_key(aes_key, loaded_public)
...
#     loaded_private = rsa_utils.load_private_key("private.pem")
#     decrypted_aes_key = rsa_utils.decrypt_aes_key(encrypted_aes_key, loaded_private)
#     print(f"✅ Decrypted AES Key: {decrypted_aes_key.hex()}\n")

#     # Step 5: Compare original and decrypted keys
#     if aes_key == decrypted_aes_key:
#         print("✅ SUCCESS: AES key encryption/decryption via RSA is correct.")
#     else:
#         print("❌ ERROR: Decrypted AES key does not match original!")
